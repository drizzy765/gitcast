...
# Cloud API server - all AI and storage goes here
GITCAST_API_URL = os.getenv(
    "GITCAST_API_URL",
    "https://gitcast-api.onrender.com",
)

# User's optional BYOK key - takes priority over server's base key when provided
...
def ai_provider_key_status() -> dict:
    return {"groq": bool(os.getenv("BYOK_KEY", "").strip())}
